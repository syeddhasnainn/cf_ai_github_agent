/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4db39ad899cca42b1c22f0fedc23ba5f)
// Runtime types generated with workerd@1.20251011.0 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Chat" | "Sandbox";
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "GITHUB_CLIENT_SECRET" | "GITHUB_CLIENT_ID">> {}
}
...
> {}
interface 
DurableObjectState<Props = unknown> {
  waitUntil(promise: Promise<any>): void;
  readonly props: Props;
  readonly id: DurableObjectId;
